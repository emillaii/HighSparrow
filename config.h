...
#define LIGHTING_LUT_UL                 1
#define LIGHTING_AA1_DL_COAXIAL         0
#define LIGHTING_AA1_DL                 0
#define LIGHTING_LPA_DL                 0
#define LIGHTING_SENSOR_UL              0	// not used for now

#define LIGHTING_SPA_DL                 3
#define LIGHTING_AA2_DL                 2
#define LIGHTING_AA2_DL_COAXIAL         0
