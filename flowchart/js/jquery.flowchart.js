...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        setOperatorParams: function(operatorId, params) {
            this.data.operators[operatorId].properties.params = params;
        },
        ...
        getOperatorParams: function (operatorId) {
            return this.data.operators[operatorId].internal.properties.params;
        },
