...
public:
    ...
    bool Move_SZ_SY_X_Y_Z_Sync(double x,double y,double z,bool check_autochthonous = false,double check_distance = 10, int timeout = 3000);
    bool Move_SZ_SY_X_YS_Z_Sync(double x,double y,double z,bool check_autochthonous = false,double check_distance = 10, int timeout = 3000);
