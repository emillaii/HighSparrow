                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            TextField {
                                Layout.preferredWidth: 150
                                id: input_X_Limit
                                text: aaCoreParams.xLimit
                                onEditingFinished: {
                                    aaCoreParams.setXLimit(text)
                                }
                            }
                            Label {
                                text: qsTr("Y Limit = ")
                            ...
                            TextField {
                                Layout.preferredWidth: 150
                                id: input_Y_Limit
                                text: aaCoreParams.yLimit
                                onEditingFinished: {
                                    aaCoreParams.setYLimit(text)
                                }
                            }
                        }
                        RowLayout {
                            ...
                            TextField {
                                Layout.preferredWidth: 150
                                id: input_Z_Limit
                                text: aaCoreParams.zLimit
                                onEditingFinished: {
                                    aaCoreParams.setZLimit(text)
                                }
                            }
                            Label {
                                text: qsTr("RX Limit = ")
                            ...
                            TextField {
                                Layout.preferredWidth: 150
                                id: input_RX_Limit
                                text: aaCoreParams.rxLimit
                                onEditingFinished: {
                                    aaCoreParams.setRXLimit(text)
                                }
                            }
                        }
                        RowLayout {
                            ...
                            TextField {
                                Layout.preferredWidth: 150
                                id: input_RY_Limit
                                text: aaCoreParams.ryLimit
                                onEditingFinished: {
                                    aaCoreParams.setRYLimit(text)
                                }
                            }
                            Label {
                                text: qsTr("RZ Limit = ")
                            ...
                            TextField {
                                Layout.preferredWidth: 150
                                id: input_RZ_Limit
                                text: aaCoreParams.rzLimit
                                onEditingFinished: {
                                    aaCoreParams.setRZLimit(text)
                                }
                            }
                        }
                    }
